...
- Don't make assumptions about or based on audience background, identities or experiences
- Beware and be mindful of your biases
- Be professional and appropriate, use neutral language
- Respect and be curious of other points of view

### Brainstorm

Take time to craft the appropriate messages by considering the following
- The channels of communication
- What information you're conveying
...
- Avoid including any sensitive or private information
- Assume everyone in the company will receive the communication (You really can't control who sees it after you've sent it)
...
Deciding how you would communicate with people involved in the project
...
- Communication goals
- Communication barriers e.g. time zones, language, internet access etc

#### 2. Document and develop
Based on what you've identify above, create a communication plan with rows of each communication and the columns indicating the five points listed in Identify

#### 3. Check in
To see how well the communication is going or will work

- Anonymous survey
- Polls
- Open feedback during team meetings
- One-on-one conversations
- Check-ins with key stakeholders

## Project documentations
Below are main documents that your projects should have
1. Project Charter: overview of the projects with key elements
2. Statement of work: legally binding document showing the project work
3. Risk management plan: Potential risks and how to manage them
4. Schedule: timeline and project lifecycle
5. Budget: the estimate of the cost of the project
6. Communication plan: how to communicate with stakeholders
7. Shared folder: contains relevant documentations
8. RACI chart: indicates who is responsible, accountable, consulted and informed within the project
...
You can use websites like [resume worded](https://resumeworded.com/) and [enhancv](https://enhancv.com/)


### Professional profile

You will need to maintain an online profile as well for people to reach out to you, this is usually on linkedin. It should contain the following

- Photo
- Headline e.g. Programming Wizard
- About/Summary
- Experience
- Education
- Skills
