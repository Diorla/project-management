...
### Google Sheet
Or Microsoft Excel. You can use it for the following and more
1. [Project timeline](https://docs.google.com/spreadsheets/d/1Us-j-BAG3kiIJENBt3SqRXkJQL_TZh-yejJyZzq9L60/template/preview#gid=1709744959)
2. [Project tracking](https://docs.google.com/spreadsheets/d/12AK5slxygSxj8nmjS39SCnEFkCy8WZDbgN0vSQh2xwg/template/preview?resourcekey=0-__sqaWcGZavYWgXz-WD4jQ#gid=1161341563)
3. [Gantt Chart](https://docs.google.com/spreadsheets/d/1Yc1KA_7DMwBqyt2Zcx68HAV3oEp1FnUt-undm0XHgqM/template/preview?resourcekey=0-y-3VgQEbmAVaiEGfeyeJ-g#gid=1115838130)
4. [Event Marketing Timeline](https://docs.google.com/spreadsheets/d/10GindXMsW6z0pFvd5Ymjz_PS0dXJ5eCkl3KDKEPO9qY/template/preview#gid=541890420)

## Other tools

You should familiarise yourself with some other tools and try to use them in any capacity to become familiar with them

- [Asana](https://asana.com/) ([Guide](https://asana.com/guide))
...
- [Project Libre](https://www.projectlibre.com/) (open source alternative to Microsoft Project)
- [Smartsheet](https://www.smartsheet.com/)

## Tool tracker
You need to keep track of your tools, you need to do the following

1. Create a spreadsheet
2. Add column that has the following headers:
   1. Name
   2. Description/Benefit
   3. Link to product website
   4. Link to important tutorial or training
   5. Cost to use
   6. Requirements (training/equipment)
   7. Current experience with tool
   8. Notes
3. Format your sheet like colour coding, add sort etc

![tool tracker](./asset/tooltracker.png)