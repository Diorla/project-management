...
It is important to "Respond to change over following a plan". Adaptation is a key part of Agile development. This involves three stages
...
### Step 1
Identifying a need for change might depend on change in the following
1. Scope
2. Time
3. Cost or resources

This need might come from any of the stakeholders like the Product Owner, Project Manager, Scrum Master, or the Development Team themselves.


### Step 2
The process of deciding how to make the change requires the following
1. Identify the "decider", usually the Product Owner or senior stakeholder. This ensure consistency and accountability
2. Develop and share what factors are important to the decision
3. Openly discuss the benefits and costs of the decision
4. Document the decision

### Step 3
- Document the change and decision-making process: meeting notes, pros/cons, assumptions and data that resulted in the change
- Capture the change in any affected artifacts: Update roadmaps, backlog, staffing, integration date etc that may be affected
- Share the change with all affected stakeholders
- Monitor the change for a certain amount of time

## Switching to Agile
You may be part of a company that wants to change to agile process. This is a big step, and depending on your seniority, you may play a big role in this change. Hence, you must a big influencer in this process.

### What does it mean to be an influencer
This is not a social media stardom sort of thing. This means the ability to lead and change people's behaviour. It's not the same as persuasion, persuasion is short term, influencing is long term, requires belief in the change.

### Keys to influencing

1. Clarifying measurable result: Let them know what you want, and why you want it
2. Find vital behaviours. This means important moments or actions that are needed in the context of the change that they are seeking. Things that needs to be done
3. Use the 6 sources of influence: Identify the ones that are most appropriate for each different stakeholders

#### 6 sources of influence
1. Personal motivation: Help them love it
2. Personal ability: Make them be able to do it
3. Social motivation: Encourage teamwork or co-operation like team members reminding ech other
4. Social ability: Promote positive social interaction around that project
5. Structural motivation: Rewards and incentives, could be as small as coffee at the end of each sprint
6. Structural ability: Create an environment that support this new behaviour, e.g. switch to Kanban
...
This two activities are important in project management and differs

### Managing

This means overseeing the work of employees which may include the following
...
### Coaching
In Agile development, project management is more about empowering the team. It is a two communication that involves the following
...
One of the major way tech organisation are embracing agile development with devOps
...
Typically, a scrum team should not be more than 10 team members, but sometimes, you really need a bigger team and there is nothing you can do about that. Also, a product may be so large, that it requires multiple teams. There are s several approaches to handle this. Below are some of the approaches
...
[This](https://www.scaledagileframework.com/) draws concepts from Kanban, Scrum, Extreme Programming (XP), Design Thinking methodologies. It is based on the core values:
...
### Scrums of Scrums
[This](https://www.atlassian.com/agile/scrum/scrum-of-scrums) involves integrating several smaller Scrum teams to together. This involves
- A group of at least 12 people are divided into scrum teams of 5 to 10 people each
- Each team has a scrum master that acts as "ambassador" for each team.
- These Scrum masters hold scrum of scrums meeting regularly (weekly, daily, twice a week etc).

### Large Scale Scrum (LeSS)

[This](https://less.works/) involves applying values, purpose and elements of Scrum to an organisation. It involves the following 10 principles
...
There are two frameworks based on this, **Basic LeSS** for 1-50 people, and **LeSS Huge** for more than 50 employees

### Disciplined Agile Delivery (DAD)

[This](https://www.pmi.org/disciplined-agile/process/introduction-to-dad) is an hybrid approach that combines strategies from various Agile frameworks. It is divided into four layers
...
### The Spotify Model
This has been discussed previously, it involves squads, tribes, chapters and guilds.


## Best practices
- Treat the models stated above like LeSS as general idea not instruction manuals
- Don't try to scale without understanding Agile process
- Tailor your solutions to your need
- Don't scale unless it is necessary. The larger the team, the more complex and difficult the project becomes.