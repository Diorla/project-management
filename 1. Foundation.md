...
![Project manager](./asset/1.png)

![Operations Associate](./asset/2.png)
...
![Core responsibilities](./asset/3.png)
...
![Cross-functional role](./asset/4.png)
...
![Classic org](./asset/Classic-structure.jpg)
...
![Matrix org](./asset/Matrix-structure.jpg)
...
- Governance is the management framework for decision making based, determining who is accountable and responsible, in short, who is in charge.
- Corporate governance: every organisation have standards and practices determines how they operate. Examples includes steering committees
- Project governance: this is the job of the PM. It's the framework for project decisions

Because a PM role doesn't exist in a vacuum, it's within an organisation, there is an intersection between corporate and project governance.

## Job search

### Analyse job listings
- Pull 10 job descriptions
- Combine all the requirements and order them according to appearance

Job listing have different requirements because the demands are different, like some might focus on customer relationship while others might be focused on the project

### Professional inventory
Now, you need to beef up your CV. Here are some of the skills that you will need
- Technical (hard) skills: like writing, programming etc
- Interpersonal skills: enable you to navigate work environment and well with other people
- Personal qualities: things like honesty, sense of humour etc
- Education and certification

### Matching profile with job requirement
Group the descriptions into three categories
- Green: skills that are directly relevant to your target role. Emphasize and highlight them on your resume
- Orange: relevant or transferable skills
- Red: not relevant and shouldn't be on the resume. Steer clear of them during interviews

## Glossary
The courses glossary can be found [here](https://docs.google.com/document/d/100bNgK8Ly_30OjVzjRPkxBNle-zF92YtclgXCg_doGU/template/preview)